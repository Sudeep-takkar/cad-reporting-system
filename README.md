...
### Data Architecture
- **Client-side filtering**: All 1,000 records are fetched once and filtered in-memory for fast, responsive interactions
...
- **Memoized computations**: Chart data and filters use React.useMemo
...
- **Styling**: Tailwind CSS class combinations and responsive layouts
